...
const Terms = () => {
  return (
    <div className="terms-container">
      ...
      <ul>
        <li>You are responsible for the accuracy of your profile and any content you post.</li>
        <li>You will not harass, abuse, or harm another user.</li>
        <li>You will not impersonate anyone or create fake accounts.</li>
        <li>You will not upload offensive or explicit content.</li>
      </ul>
      ...
      <h2>9. Contact Us</h2>
      <p>If you have any questions about these Terms, contact us at <a href="mailto:support@amoryn.com">support@amoryn.com</a>.</p>
    </div>
  );
};
