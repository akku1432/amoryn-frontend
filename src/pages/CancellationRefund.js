...
const CancellationRefund = () => (
  <div className="p-6 max-w-3xl mx-auto text-gray-800">
    ...
    <p>The transaction ID or payment confirmation receipt from PayPal.</p>
